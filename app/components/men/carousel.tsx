...
export default function Carousel() {
  ...
  return (
    <>
      <div className="min-h-[78vh] md:block gallery hidden overflow-x-hidden">
        <Slider {...settings}>
          <div className="py-5 min-h-[78vh] pl-6 bg-linear-to-b from-black/80 to-pink-900/95 to-95%">
          ...
          <div className="py-5 min-h-[78vh] pl-6 bg-linear-to-b from-blue-900/80 to-yellow-900/95 to-95%">
            <div className="flex space-x-6 md:flex-row flex-col">
              <div className="w-[35%] py-7">
                <div className="px-6 pb-32">
                  <p className="w-auto mb-2 px-4 py-0.5 inline-block rounded-md bg-white">
          ...
          <div className="py-5 min-h-[78vh] pl-6 bg-linear-to-b from-black/80 to-gray-900/95 to-95%">
            <div className="flex space-x-6 md:flex-row flex-col">
              <div className="w-[35%] py-7">
                <div className="px-6 pb-32">
                  <p className="w-auto mb-2 px-4 py-0.5 inline-block rounded-md bg-white">
      ...
      <div className="min-h-[60vh] w-full gallery overflow-x-hidden md:hidden block">
        <Slider {...settings}>
          <div className=" w-full h-[60vh] pl-6 bg-linear-to-b from-yellow-900/80 to-gray-900/95 to-95% p-2.5 pt-5 pb-18">
            <div
          ...
          <div className=" w-full h-[60vh] pl-6 bg-linear-to-b from-red-900/80 to-gray-900/95 p-2.5 pt-5 pb-18">
            <div
              className="w-full h-full relative"
              style={{
                backgroundImage: `url('/men/carousel/2.png')`,
