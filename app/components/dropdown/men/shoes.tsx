    ...
    <div className=" bg-white grid shadow-md grid-cols-12 gap-5 p-6 pt-5 pl-8 pb-30">
      <div className="md:col-span-2 col-span-12">
        <div className="flex flex-col space-y-2.5">
          ...
          <p className="whitespace-nowrap tex-sm">Open shoes</p>
      ...
      <div className="md:col-span-2 col-span-12">
        <div className="flex flex-col space-y-2.5">
          ...
          <p className="whitespace-nowrap tex-sm">Explore all</p>
          <p className="whitespace-nowrap tex-sm">Classic sneakers</p>
          <p className="whitespace-nowrap tex-sm">High-top sneakers</p>
          <p className="whitespace-nowrap tex-sm">Slip-ons</p>
          <p className="whitespace-nowrap tex-sm">Canvas shoes</p>
          <p className="whitespace-nowrap tex-sm">Spotlight Sneaker</p>
          <p className="whitespace-nowrap tex-sm"></p>
          <p className="whitespace-nowrap tex-sm"></p>
        </div>
      </div>
