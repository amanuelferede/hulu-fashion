    ...
    <div className=" bg-white grid shadow-md grid-cols-12 gap-5 p-6 pt-5 pl-8 pb-30">
      <div className="md:col-span-2 col-span-12">
        <div className="flex flex-col space-y-2.5">
          ...
          <p className="whitespace-nowrap tex-sm">Classic tops</p>
          <p className="whitespace-nowrap tex-sm">Button-up shirts</p>
          <p className="whitespace-nowrap tex-sm">Pants & jeans</p>
          <p className="whitespace-nowrap tex-sm">Pants & jeans</p>
      ...
      <div className="md:col-span-2 col-span-12">
        <div className="flex flex-col space-y-2.5">
          <p className="whitespace-nowrap tex-sm">Shorts</p>
      ...
      <div className="md:col-span-3 col-span-12">
        <div>
          <Image
            src={`/dropdown/men/streetswear/1.jpg`}
            alt="logo"
            sizes="100vh"
            width={0}
            height={0}
