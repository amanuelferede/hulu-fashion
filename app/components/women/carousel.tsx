            ...
            <div className="flex space-x-6">
              <div className="w-[35%] py-7">
                ...
                <div className="flex space-x-1.5 pl-1.5">
                  <Image
                    src={`/women/carousel/sell 1/1.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
                  ...
                  />
                  <Image
                    src={`/women/carousel/sell 1/2.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
                  ...
                  />
                  <Image
                    src={`/women/carousel/sell 1/3.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
                  ...
                  />
                  <Image
                    src={`/women/carousel/sell 1/4.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
              ...
              <div
                className="w-[65%]"
                style={{
                  backgroundImage: `url('/women/carousel/3.png')`,
          ...
          <div className="py-5 min-h-[78vh] bg-linear-to-b pl-6 from-red-900/80 to-gray-900/95 to-95%">
            <div className="flex space-x-6 md:flex-row flex-col">
              <div className="w-[35%] py-7">
                ...
                <div className="flex space-x-1.5 pl-1.5">
                  <Image
                    src={`/women/carousel/sell 2/1.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
                  ...
                  />
                  <Image
                    src={`/women/carousel/sell 2/2.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
                  ...
                  />
                  <Image
                    src={`/women/carousel/sell 2/3.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
                  ...
                  />
                  <Image
                    src={`/women/carousel/sell 2/4.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
          ...
          <div className="py-5 min-h-[78vh] bg-linear-to-b pl-6 from-blue-900/80 to-gray-900/95 to-95%">
            <div className="flex space-x-6 md:flex-row flex-col">
              <div className="w-[35%] py-7">
                ...
                <div className="flex space-x-1.5 pl-1.5">
                  <Image
                    src={`/women/carousel/sell 3/1.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
                  ...
                  />
                  <Image
                    src={`/women/carousel/sell 3/2.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
                  ...
                  />
                  <Image
                    src={`/women/carousel/sell 3/3.jpg`}
                    alt="logo"
                    sizes="100vh"
                    width={0}
                    height={0}
